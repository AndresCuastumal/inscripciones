...
$registro=0;
    ...
    $sentenciaSQL=$conn->prepare("SELECT e.id, e.nom_comercial, e.nit as NIT, e.fecha_registro,
                                    ...
                                    j.nom_sujeto 
                                      ...
                                      INNER JOIN bdfuid.comuna c ON c.id = e.id_comuna 
                                      INNER JOIN bdfuid.sujeto j ON j.id = e.id_sujeto                                      
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="bg-light text-info ">
        ...
        <p class="text-justify" >El sistema muestra un listado de establecimientos asignados a usted según sujeto y comuna que maneja; que han solicitado visita en el presente año.  
